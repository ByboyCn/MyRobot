...
namespace My.QQ
{
    public class QQLogin : Window
    {
        ...
        protected async override void InitializeComponent()
        {
                        ...
                        new Panel
                        {
                            Children =
                            {
                                ...
                                new Picture
                                {
                                    ...
                                    MarginLeft = 10.7f,
                                    MarginTop = 10.4f,
                                    Source="res://My.QQ.CPF/Resources/qq.png",
                                },
                                new Panel
                                {
                                    Name="headPanel",
                                    ...
                                    Children =
                                    {
                                        ...
                                        new Border
                                        {
                                            ...
                                            CornerRadius = "35",
                                            IsAntiAlias = true,
                                            Background="#fff",//Padding=new Thickness(-8),
                                            Child =
                                            new Ellipse
                                            {
                                                StrokeStyle = "1",
                                                StrokeFill = "#fff",
                                                Fill = "url(res://My.QQ.CPF/Resources/headQQ.png) Clamp Fill 0,0,0,0",
                                                Width=70f,
                                                Height=70f,
                                            }
                                        }
                            ...
                            Child = new Panel
                            {
                                Children =
                                {
                                    ...
                                    new Picture
                                    {
                                        ...
                                        MarginLeft = 185.4f,
                                        MarginTop = 4.7f,
                                        Source="res://My.QQ.CPF/Resources/键盘.png",
                                    },
                                    new TextBlock
                                    {
                                        Classes=
            ...
            LoadStyleFile("res://My.QQ.CPF/css/QQLogin.css");
            //加载样式文件，文件需要设置为内嵌资源
            Icon = await ResourceManager.GetImage("res://My.QQ.CPF/Resources/headQQ.png");
        }
        ...
        void Pop(CpfObject cpfObject, object e)
        {
            if (popup == null) {
                ...
                popup.LoadStyleFile("res://My.QQ.CPF/css/QQLogin.css");
            }
